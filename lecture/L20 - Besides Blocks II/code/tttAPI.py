...
def getmovesfromoracle(board):
    ...
    return(eval(urllib.request.urlopen("http://cloud.cs.berkeley.edu:8090/gcweb/service/gamesman/puzzles/ttt/getNextMoveValues;board=" + urlify(board) + ";width=3;height=3;pieces=3").read().decode())['response'])
